            ...
            <div class="card admin-maxwith">
                ...
                <div class="card-body p-sm-0">
                    ...
                    <div class="tab-content">
                        <div id="wp-chatbot-openai-settings" class="tab-pane in active my-4">
                            <?php 
                                require_once(QCLD_wpCHATBOT_PLUGIN_DIR_PATH . 'includes/openai/admin/settings.php'); 
                            ?>
                        </div>
                        <div id="wp-chatbot-openai-training-model" class="tab-pane my-4">
                            <?php 
                                require_once(QCLD_wpCHATBOT_PLUGIN_DIR_PATH . 'includes/openai/admin/files.php');
                            ?>
                        </div>
                        <div id="wp-chatbot-data_post_converter" class="tab-pane my-4">
                            <?php 
                                require_once(QCLD_wpCHATBOT_PLUGIN_DIR_PATH . 'includes/openai/admin/data_post_converter.php');
                            ?>
                        </div>
                        <div id="wp-chatbot-openai-help" class="tab-pane my-4">
