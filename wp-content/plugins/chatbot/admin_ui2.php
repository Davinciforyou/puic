        ...
        <div class="wpbot_single_addon_wrapper">
                ...
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        ...
                        <div class="wpbot_addon_details">
							...
							<a class="button button-secondary" href="https://www.wpbot.pro/" target="_blank" >Upgrade to Pro</a>
                        </div>            
                    </div>
			...
			<div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Bot - Woocommerce Module</div>
                        <div class="wpbot_addon_details">
                        <?php if(class_exists('QCLD_MAILING_LIST_INTEGRATION_ADDON')){
                            ...
                            <?php if(function_exists('qcpd_wpwc_addon_lang_init')){
                                ...
                                ?>
                                <a class="button button-secondary" href="https://www.wpbot.pro/" target="_blank" >Get It Now</a>
                                <?php
                            } ?>
                        </div>            
                    </div>
                ...
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        ...
                        <div class="wpbot_addon_details">
                            ...
                            <p>Conversational form builder Module</p>
                            <?php if(function_exists('qcformbuilder_forms_load')){
                                ?>
                                <a class="button button-secondary" href="<?php echo esc_url(admin_url('admin.php?page=qcformbuilder-forms')); ?>" >Settings</a>
                                <?php if($cfb=='Free'): ?>
                                <a class="button button-secondary" href="https://www.quantumcloud.com/products/conversations-and-form-builder/" target="_blank" >Upgrade to Pro</a>
                                <?php endif; ?>
                                <?php
                            }else{
                                ?>
			...
			<div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Chatbot STR Pro Module</div>
                        <div class="wpbot_addon_details">
			...
			<div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Multi Language Module</div>
                        <div class="wpbot_addon_details">
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Voice Message Module</div>
                        <div class="wpbot_addon_details">
                        <?php if( is_plugin_active( 'voice-message-addon/wpbotvoicemessage.php' ) ){
                            ...
                            <p>Voice Message Module for your ChatBot</p>
                            <?php if( is_plugin_active( 'voice-message-addon/wpbotvoicemessage.php' ) ){
                                ?>
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Telegram Module</div>
                        <div class="wpbot_addon_details">
			...
			<div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Open AI Module</div>
                        <div class="wpbot_addon_details">
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Extended UI Module</div>
                        <div class="wpbot_addon_details">
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Whatsapp Module</div>
                        <div class="wpbot_addon_details">
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    ...
                    <div class="wpbot_addon_content">
                        <div class="wpbot_addon_title">Voice Module</div>
                        <div class="wpbot_addon_details">
